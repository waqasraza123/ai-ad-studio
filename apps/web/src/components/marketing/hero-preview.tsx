...
const workflowHighlights = [
  {
    label: "Brief",
    title: "Lock the request",
    detail: "Goals, assets, and constraints are set.",
    icon: WandSparkles
  },
  {
    label: "Review",
    title: "Choose the winner",
    detail: "Teams approve preview-ready frames.",
    icon: CheckCircle2
  },
  {
    label: "Publish",
    title: "Ship the canonical export",
    detail: "Showcase and delivery stay aligned.",
    icon: Play
  }
]
        ...
        <div className="mt-6 grid gap-4 xl:grid-cols-[minmax(0,1fr)_15.5rem]">
          ...
          <aside className="theme-soft-panel rounded-[1.7rem] border p-4 sm:p-5">
            <div className="border-b border-[rgba(15,23,42,0.08)] pb-4">
              <p className="theme-marketing-eyebrow">Key checkpoints</p>
